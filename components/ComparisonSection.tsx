...
const comparisonTranslations: Record<string, {
  ...
  gu: {
    ...
    bad: [
      "પરિવારના સભ્યોની માહિતી અલગ અલગ જગ્યાએ",
      "Events અને તહેવારોની માહિતી સમયસર મળતી નથી",
      "સમાજના Business અને Jobs શોધવા મુશ્કેલ",
      "Message અને માહિતી પહોંચાડવામાં સમય લાગે",
      "News અને Updates બધાને સમયસર મળતા નથી",
      "મહત્વની માહિતી ખોવાઈ જવાની શક્યતા"
    ],
    good: [
      "બધા Membersની માહિતી એક જ જગ્યાએ",
      "Events અને તહેવારોની Updates સરળતાથી",
      "Societyના Business અને Jobs સરળતાથી શોધો",
      "દરેકને Message અને Notification તરત મળે",
      "News, Updates અને Announcements એક જ જગ્યાએ",
      "મહત્વની માહિતી સુરક્ષિત રીતે સાચવો"
    ],
    bottomPills: [
      "100% સુરક્ષિત",
