...
import { Zap, Headphones, CheckCircle2, Send, Globe } from "lucide-react";
          ...
          <div className="lg:col-span-7 bg-white p-7 sm:p-9 flex flex-col justify-center">
            <div className="w-full space-y-5">
              ...
              <form onSubmit={handleSubmit} className="space-y-3.5">
                ...
                {isSubmitted && (
                  <div className="p-2.5 bg-emerald-50 border border-emerald-200 text-emerald-700 text-xs font-semibold rounded-md text-center">
                ...
                <button
                  type="submit"
                  className="w-full bg-[#0B1340] hover:bg-blue-900 text-white font-bold text-xs sm:text-sm py-3 px-5 rounded-lg shadow-md hover:shadow-lg transition-all duration-200 flex items-center justify-center gap-2 group"
                >
